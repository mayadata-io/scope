...
func (c *FakeVolumeSnapshotDatas) Get(ctx context.Context, name string, options v1.GetOptions) (result *volumesnapshotv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
...
func (c *FakeVolumeSnapshotDatas) List(ctx context.Context, opts v1.ListOptions) (result *volumesnapshotv1.VolumeSnapshotDataList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVolumeSnapshotDatas) Create(ctx context.Context, volumeSnapshotData *volumesnapshotv1.VolumeSnapshotData, opts v1.CreateOptions) (result *volumesnapshotv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
...
func (c *FakeVolumeSnapshotDatas) Update(ctx context.Context, volumeSnapshotData *volumesnapshotv1.VolumeSnapshotData, opts v1.UpdateOptions) (result *volumesnapshotv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
...
func (c *FakeVolumeSnapshotDatas) UpdateStatus(ctx context.Context, volumeSnapshotData *volumesnapshotv1.VolumeSnapshotData, opts v1.UpdateOptions) (*volumesnapshotv1.VolumeSnapshotData, error) {
	obj, err := c.Fake.
...
func (c *FakeVolumeSnapshotDatas) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *volumesnapshotv1.VolumeSnapshotData, err error) {
	obj, err := c.Fake.
