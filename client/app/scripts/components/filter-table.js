...
export const tmp = ['Current Temperature', 'Device Utilization Rate', 'Firmware Revision', 'Memory',
  'Load (1m)', 'CPU', 'Highest Temperature', 'Capacity', 'State', 'Volume claim', 'Status', '# Threads', 'Command', 'PID', 'Parent PID'];
