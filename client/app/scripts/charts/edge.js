...
function isStorageComponent(id) {
  const storageComponents = ['<persistent_volume>', '<storage_class>', '<persistent_volume_claim>', '<volume_snapshot>', '<volume_snapshot_data>', '<storage_pool>', '<disk>', '<storage_pool_claim>', '<cstor_volume>', '<cstor_volume_replica>', '<cstor_pool>'];
